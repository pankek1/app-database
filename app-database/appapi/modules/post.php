...
class Post extends GlobalMethods{
    ...
    public function add_projects($data){
        $sql = "INSERT INTO portfolio_tbl(projectTitle, projectDesc, projectDisplayPicture, creationDate) VALUES (?,?,?,?)";
        ...
        return $this->sendPayload(null, "failed", "Failed to create a new record.", 400);
    }


    public function edit_products($data){
        $sql = "UPDATE products_tbl SET product_price = ?, product_name = ? WHERE id = ?";
        ...
        try{
            ...
            return $this->sendPayload(null, "success", "Successfully edited record.", 200);
        }
        catch(\PDOException $e){
            $errmsg = $e->getMessage();
        }
        return $this->sendPayload(null, "failed", "Failed to edit  record.", 400);
    }
    ...
    public function delete_products($data){
        ...
        return $this->sendPayload(null, "failed", "Failed to delete record.", 400);
    }
    ...
    public function add_orders($data){
        $sql = "INSERT INTO orders_tbl(order_list, total) VALUES (?,?)";
